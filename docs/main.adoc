...
The subfolder +proofs+ contains a PVS patch that causes proveit to output
suitable traces and a collection of tools gathered in the OCaml package
personoj (in the folder +proofs/psnj_toolbox+ that allows to process
these traces.
